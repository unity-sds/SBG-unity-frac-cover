...
RUN conda install -y python=3.8 gdal=3.6.0
...
#RUN julia -e 'using Pkg; Pkg.add(path="https://github.com/kmsquire/ArgParse2.jl"); Pkg.instantiate()'
#RUN cp Project.toml /root/.julia/environments/v1.7/Project.toml
#RUN cp  Manifest.toml /root/.julia/environments/v1.7/Manifest.toml
#RUN julia -e 'using Pkg; Pkg.instantiate(); Pkg.precompile()'
RUN julia -e 'using Pkg; Pkg.activate("."); Pkg.add(path="https://github.com/kmsquire/ArgParse2.jl"); Pkg.instantiate(); Pkg.precompile()'
...
COPY process.py .
#RUN echo JULIA_PROJECT="/app/SpectralUnmixing" >> ~/.bashrc
